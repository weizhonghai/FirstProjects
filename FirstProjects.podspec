...
#  s.ios.library = 'CommonCrypto'
  ...
  s.subspec 'CALScanQRCode' do |ss|
  	...
  	# ss.source_files = 'FirstProjects/FirstProjects/FirstProjects/CALScanQRCode/*.{h,m}'
  ...
  # s.subspec 'CALScanQRCode' do |ss|
  # 	ss.source_files = 'FirstProjects/FirstProjects/FirstProjects/CALScanQRCode/CALScanQRCodeCameraView.{h,m}'
  # 	ss.public_header_files = 'FirstProjects/FirstProjects/FirstProjects/CALScanQRCode/CALScanQRCodeCameraView.h'
  # end
